...
let usage () =
  prerr_endline
    "Usage: missiond-lispc <emit-json|emit-v3|emit-universe|emit-workflows|check-v3|check-workflow|check-project|check-auth-domain> --file <path>|--dir <path>|--blueprint <path>|--workflow-dir <path>";
  2
