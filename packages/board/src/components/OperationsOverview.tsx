...
import { Activity, AlertTriangle, Radio, RefreshCw, Server, Wifi } from 'lucide-react';
...
export function OperationsOverview() {
  ...
  return (
    <section className="px-4 pb-2 pt-1 sm:px-8">
      <div className="grid gap-3 border-y border-neutral-900 bg-neutral-950/35 py-3 xl:grid-cols-[1.35fr_1fr_1fr]">
        <div className="min-w-0">
          ...
          <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
            ...
            <Stat label="Evidence" value={overview?.evidence.verified ?? 0} tone={overview?.evidence.missing ? 'warn' : 'good'} />
          </div>
        ...
        <div className="min-w-0 rounded-md border border-neutral-800 bg-neutral-950/70 p-3">
          <div className="mb-2 flex items-center justify-between gap-2">
            ...
            <span className="font-mono text-[11px] text-neutral-500">{overview?.slots.running ?? 0}/{overview?.slots.total ?? 0}</span>
          </div>
