...
export const SLOT_COLORS: Record<string, { badge: string; border: string }> = {
...
export const SWIMLANES = [
  ...
  { id: 'sys',     label: 'System',    types: ['slot_state_changed', 'memory_phase_changed', 'briefing_batch_started', 'briefing_summary_generated', 'narration_batch_started', 'narration_session_started', 'narration_completed', 'narration_failed'] },
];
