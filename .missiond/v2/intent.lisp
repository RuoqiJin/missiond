...
(intent missiond-v2
  ...
  (navigation-assets
    ...
    (extensible-domain-count-test
      ...
      :status code-aligned)
    ;; ── wave 19 + wave 20 + wave 21 machine-contract / dispatch SSOT additions ──
