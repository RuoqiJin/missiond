(work-order-plan
  ...
  :id "wo-20260601153500-router-codex-sources"
  :intent "wo-20260601153500-router-codex-sources"
  :status draft
  :accepted_shards
    ((shard default
       :accepted_shard_id "wo-20260601153500-router-codex-sources-shard-default"
       :read_scope ["."]
