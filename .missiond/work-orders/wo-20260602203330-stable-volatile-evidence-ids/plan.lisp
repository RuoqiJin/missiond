(work-order-plan
  ...
  :intent "wo-20260602203330-stable-volatile-evidence-ids"
  :status draft
  :accepted_shards
    ((shard default
       :accepted_shard_id "wo-20260602203330-stable-volatile-evidence-ids-shard-default"
       :read_scope ["."]
       ...
       :acceptance ["cargo test -p missiond-daemon --bin missiond context_gather"
                    ...
                    "live mission_context_gather returns stable runtime/support evidence IDs after redeploy"])))
