(plan-draft
  ...
  :steps [
    ...
    (step s5 :status completed :text "Add focused unit coverage and rerun provider-box tests.")
    (step s6 :status pending :text "Deploy to mac mini and rerun the same iOS backend-channel prompt until a durable reply is produced.")
  ]
  :write-scope ["crates/missiond-daemon/src/provider_box/codex_driver.rs" "crates/missiond-core/src/ws/server.rs"]
