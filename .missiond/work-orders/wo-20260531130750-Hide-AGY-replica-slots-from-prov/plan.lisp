(work-order-plan
  ...
  :id "wo-20260531130750-Hide-AGY-replica-slots-from-prov"
  :intent "wo-20260531130750-Hide-AGY-replica-slots-from-prov"
  :status draft
  :accepted_shards
    ((shard default
       :accepted_shard_id "wo-20260531130750-Hide-AGY-replica-slots-from-prov-shard-default"
       :read_scope ["."]
