(work-order-plan
  ...
  :accepted_shards
    ((shard default
       ...
       :read_scope ["."]
       :write_scope ["crates/missiond-core/" "crates/missiond-daemon/" "packages/board/src/types.ts" "scripts/check-v3-interaction-gateway-isomorphism.mjs" "scripts/check-v3-runtime-path-hygiene.mjs" "scripts/check-v3-workstation-pool-isomorphism.mjs" "scripts/generated/"]
