...
(workflow commit-lisp-convergence
  ...
  :steps
    ((step s1 :name resolve-project
     ...
     (step s2 :name read-commit-snapshot
     ...
     (step s5 :name create-backfill-task
     ...
     (step s6 :name optional-auto-delegate
