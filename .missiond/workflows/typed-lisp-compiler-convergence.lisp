(workflow typed-lisp-compiler-convergence
  ...
  :core ((step s1 :logic "run the OCaml structural gate first when toolchain exists; otherwise return a typed toolchain diagnostic and keep JS gates as compatibility wrappers")
         ...
         (step s5 :logic "allow code-anchor JS checkers to continue validating Rust/TS/MJS file anchors after the OCaml Lisp structural gate succeeds"))
  :risk-gates [no-runtime-hot-path no-auto-toolchain-install no-handwritten-compiled-json]
