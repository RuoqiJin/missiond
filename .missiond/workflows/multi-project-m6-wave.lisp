(workflow multi-project-m6-wave
  ...
  :egress [context-packs questions hypotheses evidence_needed findings design_options accepted-shards worker-boardtasks maturity-registry-delta global-m6-report decision-items]
  :risk-gates
    ((gate g1 :rule "Lisp/checker changes precede runtime code changes.")
     ...
     (gate g6 :rule "No selected project may skip review-question/evidence-plan unless exact-shard-ready=true is explicit in the parent BoardTask."))
  :completion
