(workflow typed-lisp-compiler-cleanup
  ...
  :authority [typed-lisp-compiler-convergence project-m6-depth]
  ...
  :match_rules
    ((trigger :kind manual :surface typed-lisp-compiler :when "objective asks to shrink JS checker semantics")
     ...
     (trigger :kind workflow :workflow_id multi-project-m6-wave :when "M6 depth needs a typed gate"))
  :steps
    ((step s1 :id inventory-js-semantics
     ...
     (step s2 :id extend-typed-gates
       :logic "Add OCaml validators for workflow, project maturity, universe, and M6 depth before deleting duplicate JS logic.")
     ...
     (step s4 :id compiled-json-runtime
       :logic "Extend generated compiled JSON and Rust loader coverage for universe, workflows, and maturity registry.")
  ...
  :completion
    ((criterion c1 :rule "project-m6-depth has an OCaml structural gate.")
