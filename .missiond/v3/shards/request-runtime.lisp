  (grounding-search-aggregate
    ...
    :invariants
      ["mission_context_gather MUST expose source_profile, source_summaries, evidence_lanes, evidence_items, support_catalog, authority_order, noise_diagnostics, raw_sources_omitted, and context_noise_metrics."
       ...
       "mission_context_gather MUST filter persisted evidence_items that reference compiled-deployment-policy path/source_hash values not matching the active MISSIOND_COMPILED_RUNTIME_DIR before returning or injecting them; context_noise_metrics.evidence_item_read_model MUST expose freshness_filtered_count."
