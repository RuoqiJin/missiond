    ...
    :functions
      ((function context-gather-artifact
       ...
       (function provider-box-slot-control
         ...
         :core ((step s1 :logic "normalize spawn/status/input/clear/exit requests into provider-interaction-turn rather than direct PTY writes by callers")
                (step s2 :logic "status observes the slot and returns slot_status plus screen_identity/screen_usage when visible; it does not spawn unless spawn_if_missing=true and does not create semantic answer text")
         ...
         :egress [provider-interaction-turn slot_status diagnostic])
