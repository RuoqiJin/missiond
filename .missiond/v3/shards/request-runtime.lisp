  (grounding-search-aggregate
    ...
    :invariants
      ["mission_context_gather MUST expose source_profile, source_summaries, evidence_lanes, authority_order, noise_diagnostics, raw_sources_omitted, and context_noise_metrics."
       ...
       "Deploy-ops skill_context summaries MUST expose high-confidence query-ranked operational_fact_samples as bounded compact evidence while still omitting raw operational_facts unless include_raw_sources=true or source_profile=full_debug; low-confidence samples that only match skill/source path names MUST stay out of compact context."
