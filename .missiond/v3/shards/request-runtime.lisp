  (grounding-search-aggregate
    ...
    :invariants
      ["mission_context_gather MUST expose source_profile, source_summaries, evidence_lanes, evidence_items, support_catalog, authority_order, noise_diagnostics, raw_sources_omitted, and context_noise_metrics."
       ...
       "mission_context_gather context_noise_metrics.evidence_item_read_model MUST expose hit_count, raw_hit_count, and deduplicated_count so repeated context_gather/backfill projections are visible as filtered retrieval noise."
