    ...
    :functions
      ...
      (function jarvis-result-artifact-gate
         ...
         :core ((step s1 :logic "inspect worker/Board summary notes for existing task-result-artifact hash")
                ...
                (step s12 :logic "if daemon restart or send loss leaves an idle worker slot without durable final or task-result-artifact after watchdog_grace_secs, the watchdog must wait one final settle window and re-read the live PTY screen before writing a failed diagnostic artifact")
