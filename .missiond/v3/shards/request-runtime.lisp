  (grounding-search-aggregate
    ...
    :invariants
      ["mission_context_gather MUST expose source_profile, source_summaries, evidence_lanes, evidence_items, support_catalog, authority_order, noise_diagnostics, raw_sources_omitted, and context_noise_metrics."
       ...
       "mission_context_gather deployment_events MUST expose relay_diagnostics with inferred_gap values such as deploy_center_relay_absent_or_disabled plus expected Deploy Center relay env/webhook fields when scoped Deploy Center events are unavailable."
