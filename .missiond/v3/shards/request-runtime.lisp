  (grounding-search-aggregate
    ...
    :invariants
      ["mission_context_gather MUST expose source_profile, source_summaries, evidence_lanes, evidence_items, support_catalog, authority_order, noise_diagnostics, raw_sources_omitted, and context_noise_metrics."
       ...
       "mission_context_gather source_profile=deploy_ops MUST distinguish no infra evidence from infra-os feature_disabled by returning source_summaries.infra.status=feature_disabled and diagnostics when MISSIOND_FEATURE_INFRA_OS_ENABLE/MISSIOND_FULL_OS_ENABLE is not enabled."
