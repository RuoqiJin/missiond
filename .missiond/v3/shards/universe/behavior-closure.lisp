(behavior-universe missiond
  ...
  (behavior
    ...
    :observed ["scheduler:scripts/smoke-jarvis-intent-plan-dispatch.mjs:54"
               "scheduler:scripts/smoke-jarvis-intent-plan-dispatch.mjs:275"
               "scheduler:scripts/smoke-jarvis-intent-plan-dispatch.mjs:299"]
    :code ["scripts/smoke-jarvis-intent-plan-dispatch.mjs"]
    :effects []
    (anchor
      :role scheduler
    ...
    (anchor
      :role scheduler
      :observed "scheduler:scripts/smoke-jarvis-intent-plan-dispatch.mjs:275"
      :file "scripts/smoke-jarvis-intent-plan-dispatch.mjs"
      :symbol "followTaskUntilTerminal")
    (anchor
      :role scheduler
      :observed "scheduler:scripts/smoke-jarvis-intent-plan-dispatch.mjs:299"
      :file "scripts/smoke-jarvis-intent-plan-dispatch.mjs"
      :symbol "followTaskUntilTerminal")
    (trigger
      :from-file "scripts/smoke-jarvis-intent-plan-dispatch.mjs"
  ...
  (behavior
    ...
    :kind subprocess
    :owner control-plane-kernel
    :observed ["subprocess:crates/missiond-daemon/src/engine/shared_memory.rs:4783"
               "subprocess:crates/missiond-daemon/src/engine/shared_memory.rs:4819"
               "subprocess:crates/missiond-daemon/src/engine/shared_memory.rs:4839"]
    ...
    (anchor
      :role subprocess
      :observed "subprocess:crates/missiond-daemon/src/engine/shared_memory.rs:4819"
      :file "crates/missiond-daemon/src/engine/shared_memory.rs"
      :symbol "git_changed_paths_between")
    (anchor
      :role subprocess
      :observed "subprocess:crates/missiond-daemon/src/engine/shared_memory.rs:4839"
      :file "crates/missiond-daemon/src/engine/shared_memory.rs"
      :symbol "git_head")
    (trigger
