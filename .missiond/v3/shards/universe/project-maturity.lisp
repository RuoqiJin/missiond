...
(project-maturity-registry
    ...
    (maturity :id xjp-image-service :current M3 :target M6 :gap [deploy-center-registration media-domain-readiness object-storage-runtime-smoke final-m6-report])
    (maturity :id xjp-video-service :current M3 :target M6 :gap [deploy-center-registration media-domain-readiness transcode-runner-integration live-video-smoke final-m6-report])
    (maturity :id xjp-video-transcode-runner :current M2 :target M6 :gap [support-agent-runtime-registration video-service-contract transcode-runner-smoke final-m6-report])
