...
(project-maturity-registry
    ...
    (maturity :id search-center :current M5 :target M6 :gap [deep-research-e2e-verification browser-oauth-flow-verification final-m6-report])
    ...
    (maturity :id daily-spark :current M2 :target M6 :gap [production-domain gcp-runtime-secrets supabase-cloud-dump gcp-db-restore caddy-dns vercel-env smoke-rollout final-m6-report]))
