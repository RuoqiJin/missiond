      ...
      :driver-capabilities
        ((capability submit-turn
         ...
         (capability switch-model
           :rule "Driver declares switch behavior as launch_arg, interactive_ui, conversation_setting, or unsupported. launch_arg may require respawn; interactive_ui requires a provider-specific driver; unsupported returns MODEL_SWITCH_UNSUPPORTED. Every successful switch must be verified by durable metadata, recognized UI/footer, provider settings export, or the launch config that created a fresh session.")
