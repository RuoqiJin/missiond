  ...
  (workstation-pool
    ...
    (worker agy-gemini-communicator
      ...
      :capabilities [read-only user-facing-summary evidence-bound-summary]
      :max-concurrency 1
      :timeout-secs 120
