  (workstation-config
    ...
    (interactive-provider-box
      ...
      :callers [jarvis-intent-author jarvis-plan-author grounded-direct-answer missiond-runner board-worker-adapter codex-vision-worker gemini-router-cli provider-router-exporter xjpcode-text-provider-adapter external-apps]
