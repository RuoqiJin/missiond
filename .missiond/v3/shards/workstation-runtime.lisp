  (workstation-config
    ...
    (interactive-provider-box
      ...
      :invariants
        ["No new MissionD-owned provider CLI path may start from `claude --print`, `claude -p`, `codex exec`, `agy --print`, Gemini `-p -o stream-json`, or stdin-closed provider subprocesses."
