  ...
  :single-login-phase
    ((claude-code-default
     ...
     (agy-research
       ...
       :write-policy read-only
       :authority medium
       :runtime-rule "Agy is the Gemini successor research lane. MissionD launches `agy chat` as a PTY, recognizes idle/running/blocked/unavailable screens, and keeps it read-only until provider regression smoke passes.")
     (codex-code-worker
