(codex-boot-context
  ...
  :layers
    ((layer L0-always-on
     ...
     (layer L2-grounded-facts
       ...
       :fields [ssot_summary project_registry skill_evidence active_memory infra_deploy_facts tool_directory])
  ...
  :handoff-card
    "Use MissionD as the control plane. If you need missing facts, call mission_context_gather. If you need to change code, ensure intent.lisp/plan.lisp/accepted_shard/write_scope exist and commit through the work-order gate. Never treat PTY text as completion authority.")
