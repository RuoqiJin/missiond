    ...
    ((layer L0-always-on
       :rules
         ["Lisp is the SSOT: change Lisp first, then make code/checkers/runtime isomorphic."
          ...
          "For Codex App sessions that are not under MissionD-controlled prompt/tool injection, run node scripts/mission-context-pack.mjs --json --message \"$CODEX_USER_REQUEST\" as a deterministic pull-based bootstrap before broad repo search."
