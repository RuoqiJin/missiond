  ...
  (workstation-config
    ...
    :invariants
      ["code and research dynamic slots MUST NOT hardcode --model sonnet"
       ...
       "mission_compute_slot dynamic slot spawn wait_for_idle timeout MUST project from workstation-config timeout-policy dynamic-slot-spawn (default 60s, clamped 10..600) — never a local Some(60) literal"
