...
(missiond-blueprint
  ...
  (implementation-map
    ...
    (surface mission_plan
      ...
      :runtime-bookkeeping "plan_dag/runtime/bookkeeping.rs owns DAG runtime bookkeeping: node map, successor map, topo index, tainted-pending materialization, ready-id selection, running/pending scans, and topological outcome stitching."
