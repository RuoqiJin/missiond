...
(task-lifecycle-event-schema missiond.task-lifecycle-event.v1
  ...
  (purpose
    "Record task claims, trace starts, reads, worker commits, parent hotfixes, finalized reports, verification receipts, completions, and issues as durable lifecycle facts."
  ...
  (event-kinds
    [claim trace_start read worker_commit parent_hotfix finalized_report receipt completion issue])
  ...
  (event-contract
    ...
    (:event_kind "one of claim | trace_start | read | worker_commit | parent_hotfix | finalized_report | receipt | completion | issue.")
  ...
  (validation-contract
    ...
    :known-event-kinds [claim trace_start read worker_commit parent_hotfix finalized_report receipt completion issue]
