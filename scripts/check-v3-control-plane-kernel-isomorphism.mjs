...
function checkFiles(root, files) {
  ...
  requireAll(diagnostics, files.blueprint, sources.blueprint, [
    ...
    'A successful worker_settle(done) using an exact settle capability grant MUST atomically mark that grant consumed',
    'Public mission_shared_memory capability_grant MUST itself pass delegate authority',
  ...
  requireAll(diagnostics, files.sharedMemory, sources.sharedMemory, [
    ...
    'work lease {id} does not exist; release is fail-closed',
    'work lease {id} was not released; holder or status does not match',
    'work lease {id} does not exist; heartbeat is fail-closed',
    'work lease {id} was not heartbeated; holder or status does not match',
