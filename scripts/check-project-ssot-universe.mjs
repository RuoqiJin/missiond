...
const PROJECT_CHECKERS = new Map([
  ...
  ['xjp-project-universe', ['bash', ['.missiond/check.sh']]],
  ['xjp-image-service', ['bash', ['.missiond/check.sh']]],
  ['xjp-video-service', ['bash', ['.missiond/check.sh']]],
  ['xjp-domain-service', ['bash', ['.missiond/check.sh']]],
  ['xjp-mail-service', ['bash', ['.missiond/check.sh']]],
  ['xjp-legal-service', ['bash', ['.missiond/check.sh']]],
  ['xjp-video-transcode-runner', ['bash', ['.missiond/check.sh']]],
  ['xjp-invoice-service', ['bash', ['.missiond/check.sh']]],
...
function main() {
  ...
  requireAll(diagnostics, '.missiond/v3/missiond-blueprint.lisp', blueprint, [
    ...
    'Secret Store stores encrypted secret material, versions, rotation metadata, and namespace ACLs',
    ...
    ':proxy (:kind caddy :domain "jarvis.xiaojins.com"',
