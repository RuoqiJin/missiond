...
requireIncludes('requestSurfaces', [
  ...
  'missiond.jarvis-plan-execution-mode.v1',
  'grounded_direct_answer',
  'requires_board_task',
  'direct_answer_draft',
  'answer_source=plan_direct_answer_draft',
  'MISSIOND_JARVIS_DIRECT_ANSWER_STREAM_BUDGET_SECS',
  'typed diagnostic + result_pending',
...
requireIncludes('workstationRuntime', [
  ...
  'MUST resolve to codex_cli unless explicit break-glass',
  'missiond.jarvis-progress.v1',
  'SystemEvent::ExternalServiceEvent',
  'service_id=missiond-jarvis',
  'event_kind=jarvis_progress',
...
requireIncludes('workflow', [
  ...
  'InteractionEnvelope',
  'PermissionContext',
  'intent_archived for default Jarvis/iOS/OpenAI flow',
  'intent_draft + confirm_required only for explicit manual-review/legacy confirmation mode',
  'default Jarvis no-confirm mode may continue into grounding/key-judgment/plan',
]);
...
requireIncludes('server', [
  ...
  'MISSIOND_JARVIS_ALLOW_NON_CODEX_AUTHORS',
  'run_jarvis_codex_intent_turn',
  'run_jarvis_codex_plan_turn',
  'run_jarvis_codex_author_turn',
  ...
  'JarvisProgressBus',
  'publish_jarvis_progress_to_event_bus',
  'read_jarvis_progress_from_event_bus',
  'jarvis_progress_payload_from_event_bus_wire',
  'SystemEvent::ExternalServiceEvent',
  'missiond-jarvis',
  'jarvis_progress',
  'event_bus_projection',
  ...
  'grounded_direct_answer',
  'direct_answer_draft',
  'missiond_direct_answer_draft',
  'plan_direct_answer_draft',
  'plan_direct_answer_draft_selected',
  'JARVIS_DIRECT_ANSWER_STREAM_BUDGET_EXCEEDED',
  'MISSIOND_JARVIS_DIRECT_ANSWER_STREAM_BUDGET_SECS',
  'answer_source',
  'phase_code',
...
requireIncludes('jarvisInteractionSmoke', [
  ...
  'key_judgment_draft',
  'plan_archived',
  'JARVIS_CONFIRMATION_CARD_LEAK',
  'ARCHIVED_ARTIFACT_BODY_MISSING',
  'TERMINAL_DIRECT_ANSWER_MISSING',
  'hasArchivedArtifact',
