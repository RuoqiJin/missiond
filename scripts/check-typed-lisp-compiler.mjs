  ...
  if (toolchain.ok) {
    ...
    for (const argv of [
      ...
      if (!emit.ok) {
        ...
        for (const kind of ['artifact_contract', 'surface', 'function', 'runtime_policy', 'checker_registry', 'module_source_unit', 'agent_entry', 'agent_navigation_policy']) {
        ...
        for (const kind of ['artifact_contract', 'runtime_policy', 'checker_registry', 'module_source_unit', 'agent_entry', 'agent_navigation_policy']) {
          if (!factKinds.has(kind)) {
