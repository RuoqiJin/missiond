...
const checks = [
  ['.missiond/v3/missiond-blueprint.lisp', ['(eventbridge-policy', '(deployment-event-ingest', '(router-usage-event-ingest', '(deploy-agent-self-update-governance', 'deploy_agent_update_provenance', 'missiond.event-envelope.v1', '/webhooks/deploy-center-event', 'usage_burst', 'provider_auth_failure_burst']],
  ['.missiond/workflows/deployment-event-response.lisp', ['deployment-event-response', 'deploy-center', 'no-auto-rollback', 'task_class=deploy-ops', 'pool_hint=claude-code-deploy-ops', 'raw gh api polling loops are forbidden']],
