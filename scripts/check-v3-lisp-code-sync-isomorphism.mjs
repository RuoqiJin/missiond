...
function check(s, diagnostics) {
  ...
  requireAll(diagnostics, FILES.runtime, s.runtime, [
    ...
    'run_reconciler',
    'process_claimed_project_batch',
    'by_project',
    'lisp_code_sync_claim_due_jobs',
    'lisp_code_sync_complete_job',
    'lisp_code_sync_queue_stats',
    'enqueue_lisp_code_sync_job',
    'EnqueueLispCodeSyncJob',
    ...
    'collect_queue_status_for_state',
    '"queue"',
    ...
    'lisp_code_sync_runtime_metadata',
