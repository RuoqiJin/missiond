...
const NEEDLES = [
  ...
  ['blueprint evidence policy', '.missiond/v3/missiond-blueprint.lisp', '(evidence-governance-policy'],
  ['blueprint evidence function', '.missiond/v3/missiond-blueprint.lisp', '(function evidence-governance-view'],
  ['blueprint evidence runtime projection', '.missiond/v3/missiond-blueprint.lisp', '[mission_shared_memory.evidence_view task_result_artifacts conversations event_log knowledge_review_state board_tasks]'],
  ...
  ['blueprint stale lease status rule', '.missiond/v3/missiond-blueprint.lisp', 'status snapshots must expire stale active leases before counting activeClaims/staleClaims'],
  ...
  ['service status snapshot expires stale claims', 'crates/missiond-daemon/src/engine/shared_memory.rs', 'let expired_stale_claims = self.expire_stale_claims().await.unwrap_or(0);'],
  ['service status snapshot expired count', 'crates/missiond-daemon/src/engine/shared_memory.rs', '"expiredStaleClaims"'],
  ...
  ['service context-slice agent entry', 'crates/missiond-daemon/src/engine/shared_memory.rs', '"agentEntry"'],
  ['service context-slice project navigation artifact', 'crates/missiond-daemon/src/engine/shared_memory.rs', 'compiled-project-agent-navigation.json'],
  ['service context-slice project navigation source', 'crates/missiond-daemon/src/engine/shared_memory.rs', '"projectAgentNavigation"'],
  ['service context-slice coverage diagnostic', 'crates/missiond-daemon/src/engine/shared_memory.rs', '"coverageDiagnostic"'],
  ['service context-slice project selector', 'crates/missiond-daemon/src/engine/shared_memory.rs', 'select_project_agent_entry'],
  ...
  ['service evidence view action', 'crates/missiond-daemon/src/engine/shared_memory.rs', 'evidence_view'],
  ['service evidence view schema', 'crates/missiond-daemon/src/engine/shared_memory.rs', 'missiond.evidence-governance-view.v1'],
  ['service evidence view authority order', 'crates/missiond-daemon/src/engine/shared_memory.rs', 'authorityOrder'],
  ['service evidence view conversations lane', 'crates/missiond-daemon/src/engine/shared_memory.rs', 'provider_turn_read_model'],
  ['service evidence view timeline lane', 'crates/missiond-daemon/src/engine/shared_memory.rs', 'event_causality_projection'],
  ['service evidence view kb lane', 'crates/missiond-daemon/src/engine/shared_memory.rs', 'curated_long_term_knowledge'],
  ...
  ['mcp shell evidence_view action', 'crates/missiond-mcp/src/tools/knowledge/shared_memory.rs', '"evidence_view"'],
