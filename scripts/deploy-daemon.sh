...
ensure_launchd_runtime_root() {
  ...
  plist_set_env_from_current_env "$LAUNCHD_PLIST" "AUTH_ISSUER"
  plist_set_env_from_current_env "$LAUNCHD_PLIST" "AUTH_JWKS_URL"
  plist_set_env_from_current_env "$LAUNCHD_PLIST" "SECRET_STORE_STRICT"
  plist_set_env_from_current_env "$LAUNCHD_PLIST" "SECRET_STORE_ALLOW_ENV_FALLBACK"
  plist_set_env_from_current_env "$LAUNCHD_PLIST" "SECRET_STORE_BREAKGLASS_ENABLED"
  ...
  plist_set_env_from_current_env "$LAUNCHD_PLIST" "MISSIOND_CODEX_DURABLE_FINAL_IDLE_GRACE_SECS"
