...
const checks = [
  [
    ...
    [
      ...
      'provider-text-only-source',
      'missiond.provider-text-only-source.v1',
      'plan-atomization-graph',
      'missiond.plan-atomization-graph.v1',
  ...
  [
    'board task execution order metadata',
  ...
  [
    ...
    [
      ...
      'grounding_sources',
      'context_pack_path',
      'merge_plan_atom_runtime_metadata',
      '"atom_task_id"',
      '"atom_path"',
      '"execution_order"',
      '"dependency_policy"',
  ...
  [
    'jarvis grounded direct answer execution mode',
    'crates/missiond-core/src/ws/server.rs',
    [
      'grounded_direct_answer',
      'requires_board_task',
      ...
      '"interaction-direct-answer"',
      '"missiond.interaction-result-artifact.v1"',
      'plan.lisp declared grounded_direct_answer',
      'Unsupported Jarvis execution_mode',
    ],
  ],
  [
