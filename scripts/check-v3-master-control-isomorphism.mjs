...
function check(s, diagnostics) {
  ...
  requireAll(diagnostics, FILES.masterControl, s.masterControl, [
    ...
    'event_summary',
    'phase:',
    'No active objective means no-op',
    'mission_nightly_evolution',
    'MISSIOND_NIGHTLY_EVOLUTION_SCHEDULE=true',
    'The active BoardTask shown above is the only load-bearing objective',
    'follow its description as the load-bearing objective',
    'Hard workflow contracts are enforced by MissionD runtime/workflow.lisp/checkers',
    'query exactly that BoardTask by id',
    'Do not call mission_kb_query',
    ...
    'perform the corresponding MissionD MCP mutation',
    'mutation is not possible, return blocked',
