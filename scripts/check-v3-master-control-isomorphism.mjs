...
function check(s, diagnostics) {
  requireAll(diagnostics, FILES.blueprint, s.blueprint, [
    ...
    'do not call mission_kb_query, mission_conversation_query, provider-log tools, mission_intent, or mission_convergence_status unless the active task explicitly opts them in',
