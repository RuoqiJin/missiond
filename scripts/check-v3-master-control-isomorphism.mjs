...
function check(s, diagnostics) {
  requireAll(diagnostics, FILES.blueprint, s.blueprint, [
    ...
    'MissionD V3 SSOT Lisp, V3 checker/final-convergence static results',
    'what is logically inconsistent, missing, or optimizable',
    'Board backlog, KB, event-history, provider durable logs, worker telemetry, and historical conversations are excluded',
    'active_objective_id overrides default self-review',
    ...
    'periodic-heartbeat MAY run a lightweight control turn no more often than every 900s',
    ...
    'do not call mission_kb_query, mission_conversation_query, or provider-log tools during default periodic self-review',
  ...
  requireAll(diagnostics, FILES.masterControl, s.masterControl, [
    ...
    '默认周期自省范围只看 MissionD V3 SSOT Lisp',
    'Active objective overrides default self-review',
    'follow its description as the load-bearing objective',
    '逻辑不通',
