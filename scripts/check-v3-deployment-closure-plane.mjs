...
const required = [
  ...
  ['shard', 'Schema-owning services MUST publish a DbMigrationAuthority contract'],
  ['shard', 'MIGRATION_MODE=skip plus missing reconciliation'],
  ['shard', 'migration_mode_skip_without_reconciliation'],
  ['shard', 'migration_latest_version_behind'],
  ['shard', 'migration_checksum_mismatch'],
  ...
  ['compiler', 'migration_ledger_required'],
  ['compiler', 'migration_mode_skip_without_reconciliation'],
  ['compiler', 'migration_latest_version_behind'],
