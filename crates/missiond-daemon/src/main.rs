        ...
        match name {
            ...
            "mission_kb_analyze" => {
                ...
                let base_url = creds.get("auth_url")
                    .and_then(|v| v.as_str())
                    .unwrap_or("https://auth.example-org.com");
            ...
            "mission_reachability" => {
                ...
                let agent_fut = async {
                    ...
                    let url = match target_clone.as_str() {
                        "gcp" => "https://auth.example-org.com/deploy-agent/health",
                        "privatecloud" => "https://auth.example-org.com/tunnel/proxy/privatecloud/health",
                        "windows" | "win-3090ti" => "https://auth.example-org.com/tunnel/proxy/windows/health",
                        "ecs" => "https://auth.example-org.com/tunnel/proxy/ecs/health",
