                    ...
                    RollbackPolicy::Workstation => {
                        match descriptor.safety_check_for_workstation(n) {
                            ...
                            Ok(()) => {
                                ...
                                let outcome =
                                    super::super::workstation_dispatch::run_workstation_dispatch(
                                        state,
                                        plan,
                                        "mission_task_delegate",
                                        strategy,
...
fn map_dispatch_outcome_to_compensation(
    ...
    outcome: super::super::workstation_dispatch::WorkstationDispatchOutcome,
) -> CascadeCompensationOutcome {
    use super::super::workstation_dispatch::WorkstationDispatchOutcome as O;
    match outcome {
        O::Dispatched {
            task_brief,
            task_brief_path,
