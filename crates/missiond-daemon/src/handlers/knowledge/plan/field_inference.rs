...
pub(super) const SONNET_INFER_CALLER: &str = "plan_field_inference";
...
pub(super) fn coerce_proposal_value(
    field: &str,
    raw: &Value,
...
pub(super) fn caller_value_for_field(args: &Value, field: &str) -> Option<Value> {
    match field {
...
pub(super) fn values_equivalent(field: &str, a: &Value, b: &Value) -> bool {
    match field {
        "owned_files" => {
...
pub(super) fn deterministic_covers_all_fields(deterministic: &PlanFieldInference) -> bool {
