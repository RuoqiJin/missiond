...
use self::completion_audit::{
    auto_run_task_run_verifier, normalize_commit_status, normalize_task_run_verifier_status,
    normalize_verifier_status, parse_completions, read_report_summary, read_task_contract_id,
...
#[cfg(test)]
use self::completion_audit::{parse_string_list, read_shared_memory_ledger, CompletionRecord};
