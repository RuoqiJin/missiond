...
use self::completion_audit::{
    action_audit, action_repair, auto_run_task_run_verifier, build_preflight_summary,
    collect_all_claim_scopes, collect_specific_claim_scope, enforce_scoped_commit_completion,
...
#[cfg(test)]
use self::completion_audit::{
    audit_scoped_commit_handoff, build_contract_scope_summary, enforce_verified_completion,
    parse_string_list, pattern_matches_path, read_report_summary, read_shared_memory_ledger,
    read_task_contract_id, CompletionRecord, PorcelainEntry, FINDING_COMMIT_BLOCKED_NO_BLOCKER,
