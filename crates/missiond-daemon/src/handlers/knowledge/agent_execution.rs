...
use self::claim_lease::{action_claim, action_heartbeat, action_release, parse_claims, parse_iso};
use self::completion_audit::{
    action_audit, action_preflight_commit, action_repair, auto_run_task_run_verifier,
    ...
    parse_completions, render_string_list, summarize_durability, VALID_COMMIT_STATUSES,
    VALID_TASK_RUN_VERIFIER_STATUSES, VALID_VERIFIER_STATUSES,
};
#[cfg(test)]
use self::completion_audit::{
    audit_scoped_commit_handoff, build_contract_scope_summary, build_preflight_summary,
    collect_all_claim_scopes, collect_specific_claim_scope, enforce_verified_completion,
    evaluate_task_contract_for_preflight, parse_porcelain_status, parse_string_list,
    pattern_matches_path, read_report_summary, read_shared_memory_ledger, read_task_contract_id,
...
use self::log_surface::{
    ...
    sanitize_trace_backend, sexp, touch_last_updated, write_log_file, Counter, TraceEvent,
