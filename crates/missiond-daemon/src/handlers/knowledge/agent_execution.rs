...
use self::completion_audit::{
    auto_run_task_run_verifier, build_preflight_summary, collect_all_claim_scopes,
    collect_specific_claim_scope, evaluate_task_contract_for_preflight, normalize_commit_status,
    normalize_task_run_verifier_status, normalize_verifier_status, parse_completions,
    parse_porcelain_status, read_report_summary, read_task_contract_id, run_git_status,
    summarize_durability, FINDING_COMMIT_BLOCKED_NO_BLOCKER, FINDING_COMMIT_STATUS_NO_HASH,
    FINDING_SCOPED_COMMIT_VIOLATION, VALID_COMMIT_STATUSES, VALID_TASK_RUN_VERIFIER_STATUSES,
    VALID_VERIFIER_STATUSES,
};
#[cfg(test)]
use self::completion_audit::{
    build_contract_scope_summary, parse_string_list, pattern_matches_path,
    read_shared_memory_ledger, CompletionRecord, PorcelainEntry,
};
