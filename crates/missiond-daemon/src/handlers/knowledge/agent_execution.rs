...
use self::claim_lease::{
    find_claim_node, parse_claims, parse_iso, scopes_overlap, DEFAULT_LEASE_SECS, MAX_LEASE_SECS,
};
...
#[cfg(test)]
use self::completion_audit::{
    build_contract_scope_summary, enforce_verified_completion, parse_string_list,
