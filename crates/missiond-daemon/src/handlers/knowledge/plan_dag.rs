...
impl DagNode {
    ...
    fn acceptance_mode_kind(&self) -> Option<AcceptanceMode> {
    ...
    fn has_acceptance_hints(&self) -> bool {
    ...
    fn acceptance_requires_kind(&self) -> Option<AcceptanceRequires> {
    ...
    fn has_acceptance_fan_in(&self) -> bool {
