...
const FAMILIES: &[ToolFamily] = &[
    ...
    ToolFamily {
        id: "mission_context",
        title: "Conversation, timeline, and task evidence",
        tier: "primary",
        danger_level: "read-mostly",
        primary_surface: "mission_conversation_* + mission_timeline + mission_audit",
        use_when: "Read durable conversations, provider logs, timeline events, task result evidence, and tool-call traces.",
        current_tools: &[
        ...
        intent_examples: &["find worker final", "inspect tool calls", "wait for event"],
        keywords: &[
            "conversation",
            "log",
            "timeline",
