        ...
        ToolDefinition::new(
            ...
            json!({
                ...
                "properties": {
                    ...
                    "source": {"type": "string", "description": "[evidence_backfill] conversation/skills/projects/support/all"},
                    "includeCredentials": {"type": "boolean", "description": "[evidence_backfill] true=include redacted credential refs; default only counts refs"},
