...
pub fn definitions() -> Vec<ToolDefinition> {
    vec![ToolDefinition::new(
        "mission_project",
        "项目管理。resolve: 从项目名/别名/域名/URL/cwd 解析项目或未注册候选; init: 注册新项目; list: 列出所有; get: 详情; context: 全景聚合; memories: Claude记忆; universe: V3 service-runtime-universe部署拓扑; reconcile: MissionD/deploy-center/Forge 三方项目身份一致性检查; vault_sync: 参考项目lisp缓存; import_universe: 解析universe.intent.lisp批量注册; survey: 触发forge测绘生成intent.lisp",
        json!({
            "type": "object",
            "properties": {
