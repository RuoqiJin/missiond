...
pub fn definitions() -> Vec<ToolDefinition> {
    vec![
        ToolDefinition::new(
            "mission_project",
            "项目管理。init: 注册新项目; list: 列出所有; get: 详情; context: 全景聚合; memories: Claude记忆; universe: V3 service-runtime-universe部署拓扑; vault_sync: 参考项目lisp缓存; import_universe: 解析universe.intent.lisp批量注册; survey: 触发forge测绘生成intent.lisp",
            json!({
                "type": "object",
                "properties": {
                    "action": {"type": "string", "enum": ["list", "get", "set_active", "sync", "init", "context", "memories", "universe", "vault_sync", "import_universe", "survey"], "default": "list"},
