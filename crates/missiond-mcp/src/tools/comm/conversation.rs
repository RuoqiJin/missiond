...
pub fn definitions() -> Vec<ToolDefinition> {
    vec![
        ...
        ToolDefinition::new(
            "mission_conversation_query",
            "对话统一查询。list/get/search/message_search/context/events",
            json!({
                "type": "object",
                "properties": {
                    "action": {"type": "string", "enum": ["list", "get", "search", "message_search", "context", "events"], "default": "list"},
                    ...
                    "sessionId": {"type": "string", "description": "[get/search/events] 会话 ID"},
