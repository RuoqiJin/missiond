...
| CutHub | [example-app.yaml](example-app.yaml) | Next.js 16 + React 19 | 视频编辑协作平台 |
| XJP Backend | [example-backend.yaml](example-backend.yaml) | Rust + Axum + PostgreSQL | 微服务后端核心 |
